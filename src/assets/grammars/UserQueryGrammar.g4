...
multiValueVariable
    :accessor=(ANY|ALL) DOT capability=VARIABLE DOT property=VARIABLE #mvv
    |accessor=(ANY|ALL) LBRAC fBooleanExpression RBRAC DOT capability=VARIABLE DOT property=VARIABLE #mvv
    ;
